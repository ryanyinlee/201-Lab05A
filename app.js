...
function sum(a, b) { //eslint-disable-line
    ...
    let total = a + b;
    return [total, 'The sum of 4 and 7 is 11.'];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    let twoSum = sum(a, b); //gives us [7, and a STRING]
    //let twoSumFirst = twoSum[0];
    let threeSum = sum(twoSum[0], c);
    
    let twoPly = multiply(a,b);

    let threePly = multiply(twoPly[0], c);
...
function sumArray(sumArr) { //eslint-disable-line
    let firstPair = sum(testArray[0], testArray[1]);
    let secondPair = sum(firstPair[0], testArray[2]);
    return [secondPair[0], "2,3,4 was passed in as an array of numbers, and 9 is their sum."];
...
function multiplyArray(multArr) { //eslint-disable-line
    let firstPly = multiply(multArr[0], multArr[1]);
    let secondPly = multiply(firstPly[0], multArr[2]);
    return [secondPly[0], "The numbers 2,3,4 have a product of 24."];
